...
import com.goal.merchantsimulator.dto.inbound.CashInRequest;
...
@Component
public interface CashInValidation extends Function<CashInRequest, Map<Object,Object >> {

    default CashInValidation and(CashInValidation other) {
        return request -> {
