...
@Data
@ToString
public class CardTransferRequest extends DefaultRequest{
    ...
    @NotNull(message = "toCard should not be empty or null")
    @Size(max = 19,min = 16,message = "toCard size should be between 19 - 16")
