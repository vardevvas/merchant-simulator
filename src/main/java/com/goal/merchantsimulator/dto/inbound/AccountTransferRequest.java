...
@Data
@ToString
public class AccountTransferRequest extends DefaultRequest{
    ...
    @NotNull(message = "toAccount should not be empty or null")
    @Size(max = 30,min = 8,message = "toAccount size should be between 8 - 30")
    private String toAccount;

    @JsonProperty(value = "toAccountType")
    @Size(min = 2, max = 2, message = "toAccountType size should be 2")
